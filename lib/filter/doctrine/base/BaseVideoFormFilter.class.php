...
abstract class BaseVideoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nbVue'        => new sfWidgetFormFilterInput(),
      'nbLike'       => new sfWidgetFormFilterInput(),
      'nbComment'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'nbVue'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nbLike'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nbComment'    => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
