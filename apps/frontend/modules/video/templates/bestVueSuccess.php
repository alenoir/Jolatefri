<section id="content">
	<span class="choice-filter">
    	<a href="<?php echo url_for('@video_list_best_vue?filter=week');?>" <?php echo ($filter == 'week')? 'class="current"':'';?>>semaine</a> | 
    	<a href="<?php echo url_for('@video_list_best_vue?filter=month');?>" <?php echo ($filter == 'month')? 'class="current"':'';?>>mois</a> | 
    	<a href="<?php echo url_for('@video_list_best_vue?filter=all');?>" <?php echo ($filter == 'all')? 'class="current"':'';?>>année</a>
    </span>
    <h2>
	...
	<div id="pagination" class="bandeau noir">
		...
		$route = '@video_list_best_vue?filter='.$filter.'&page=';
