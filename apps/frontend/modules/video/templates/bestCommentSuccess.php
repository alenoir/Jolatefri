<section id="content">
	<span class="choice-filter">
    	<a href="<?php echo url_for('@video_list_best_comment?filter=week');?>" <?php echo ($filter == 'week')? 'class="current"':'';?>>semaine</a> | 
    	<a href="<?php echo url_for('@video_list_best_comment?filter=month');?>" <?php echo ($filter == 'month')? 'class="current"':'';?>>mois</a> | 
    	<a href="<?php echo url_for('@video_list_best_comment?filter=all');?>" <?php echo ($filter == 'all')? 'class="current"':'';?>>année</a>
    </span>
    <h2>
	...
	<div id="pagination" class="bandeau noir">
		...
		$route = '@video_list_best_comment?filter='.$filter.'&page=';
